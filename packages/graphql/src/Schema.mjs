...
function parse(prim) {
  return Graphql_facadeMjs.wrapClassType(prim);
}
...
function traverse(base, onScalar, onObject, onInterface, onUnion, onEnum, onListOpt, onNullOpt, onNonNullOpt) {
  ...
  var down = function (_t, _mods) {
    while(true) {
      var mods = _mods;
      var t = _t;
      var s = Graphql_facadeMjs.wrapClassType(t);
      switch (s.TAG) {
        case "Scalar" :
            return [
                    onScalar(s._0),
        ...
        case "List" :
            ...
            continue ;
        case "NonNull" :
            var s$1 = Graphql_facadeMjs.wrapClassType(s._0.ofType);
            switch (s$1.TAG) {
              case "Scalar" :
                  return [
                          onScalar(s$1._0),
...
export {
  ...
  List ,
  NonNull ,
  astNode$11 as astNode,
  extensionASTNodes$6 as extensionASTNodes,
  getQueryType ,
  getMutationType ,
  getSubscriptionType ,
  getTypeMap ,
